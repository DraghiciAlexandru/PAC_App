...
{
    class EcuatiiAranjamente : Panel
    {
        public EcuatiiAranjamente()
        {
            layout();
        }
        ...
        private void BtnRezN_Click(object sender, EventArgs e)
        {
            ...
            {
                Aranjamente<int> aranj = new Aranjamente<int>(lista, int.Parse(txtN.Text));
                aranj.back(0);
                if (aranj.solutii.size() == int.Parse(txtTotalN.Text))
                {
                    solutie.addFinish(i);
                }
                aranj.solutii.clear();
        ...
        private void BtnRezM_Click(object sender, EventArgs e)
        {
            ...
            {
                Aranjamente<int> aranj = new Aranjamente<int>(lista, i);
                aranj.back(0);
                if (aranj.solutii.size() == int.Parse(txtTotalM.Text))
                {
                    solutie.addFinish(i);
                }
                aranj.solutii.clear();
