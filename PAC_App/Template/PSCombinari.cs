...
namespace PAC_App.Template
{
    class PSCombinari : Panel
    {
        ...
        private void setLblCFormula(Panel formula)
        {
        ...
        private void setLblNMK(Panel formula)
        {
            ...
            lblN.Text = "k!(n-k)!";
            lblN.AutoSize = false;
            lblN.Size = new Size(70, 25);
            lblN.Location = new Point(93, 50);
            lblN.Font = new Font("Microsoft Sans Serif", 14, FontStyle.Regular);
        ...
        private void TxtM_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txtM.Text.Length != 0 && txtN.Text.Length != 0)
            {
                ...
                else
                {
                    ...
                    Combinari<int> comb = new Combinari<int>(lista, nr);
                    comb.back(0);
                    txtTotal.Text = comb.solutii.size().ToString();
                    comb.solutii.clear();
                }
            }
            else
        ...
        private void TxtN_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txtM.Text.Length != 0 && txtN.Text.Length != 0)
            {
                ...
                else
                {
                    ...
                    Combinari<int> comb = new Combinari<int>(lista, int.Parse(txtM.Text));
                    comb.back(0);
                    txtTotal.Text = comb.solutii.size().ToString();
                    comb.solutii.clear();
                }
