...
{
    public class Lista<T> : IComparable<Lista<T>>, ILista<T> where T : IComparable<T>
    {
        private Node<T> head;
        ...
        public int CompareTo(Lista<T> other)
        {
            ...
            else if (this.size() == other.size())
            {
                ...
                {
                    if (this.getAtPosition(i).CompareTo(other.getAtPosition(i)) == 1)
                        return 1;
                    else if (this.getAtPosition(i).CompareTo(other.getAtPosition(i)) == -1)
                        return -1;
                }
                return 0;
            }
